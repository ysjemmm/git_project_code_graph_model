 ...
 */
public class BizDemandToReceiveMsgEvent extends MessageEvent {
    ...
    public BizDemandToReceiveMsgEvent(Object source, Long bizDemandId, String operator, String receiver, String name) {
        super(source);
