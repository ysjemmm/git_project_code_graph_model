 ...
 */
public class OtnProjectPublishMsgEvent extends MessageEvent {

    private final Long projectId;
    private final String receiver;
    private final String name;

    private static final String MSG = "### %s  \n  产研项目 **%s** 已发布，请及时对项目成员的工作量再分配和成员评价。 \n\n  ***  \n  [查看详情](%s)";

    public OtnProjectPublishMsgEvent(Object source, Long projectId, String receiver, String name) {
        super(source);
