 ...
 */
public class BizDemandBatchTransferMsgEvent extends MessageEvent {
    ...
    public BizDemandBatchTransferMsgEvent(Object source, String initiator, String receiverAccount, Integer count) {
        super(source);
    ...
    @Override
    public void run() {
        String title = MessageTitleEnum.BIZDEMAND_BATCH_TRANSFER.getText();
