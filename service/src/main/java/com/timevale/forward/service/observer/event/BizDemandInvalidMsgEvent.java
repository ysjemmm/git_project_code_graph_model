 ...
 */
public class BizDemandInvalidMsgEvent extends MessageEvent {
    ...
    public BizDemandInvalidMsgEvent(Object source, Long bizDemandId, String operator, String receiver, String name) {
        super(source);
