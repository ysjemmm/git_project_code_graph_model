...
public class DateUtil implements DateFormatConst {
    ...
    /**
     * 将日期转化为日期字符串（默认格式{@link DateFormatConst#DEFAULT_DATE_FORMAT}）。失败返回null。
     *
     * @param date 日期
     * @return 日期字符串 string
     */
    public static String parseToString(Date date) {
        return parseToString(date, DateFormatConst.DEFAULT_DATE_FORMAT);
    }
    ...
    /**
     * 将当前时间转化为日期字符串（默认格式{@link DateFormatConst#DEFAULT_DATE_FORMAT}）。失败返回null。
     *
     * @return 日期字符串 string
     */
    public static String nowToString() {
        return parseToString(Calendar.getInstance().getTime(), DateFormatConst.DEFAULT_DATE_FORMAT);
    }
    ...
    /**
     * 将日期字符串转化为默认的日期字符串默认格式{@link DateFormatConst#DEFAULT_DATE_FORMAT}）。失败返回null。
     *
     * @param date 旧日期字符串
     * @return 默认格式的日期字符串 string
     */
    ...
    public static String getDayOfWeek(String date, Week week) {
        DateStyle dateStyle = getDateStyle(date);
        return parseToString(getDayOfWeek(parseToDate(date, dateStyle), week), dateStyle);
    }
     ...
     *
     * @param date 日期字符串
     * @return 星期 defined week of week
     */
    ...
    public static int getIntervalDays(Date date, Date otherDate) {
        int num = -1;
        Date dateTmp = parseToDate(getDate(date), DateStyle.YYYY_MM_DD);
        Date otherDateTmp = parseToDate(getDate(otherDate), DateStyle.YYYY_MM_DD);
     ...
     *
     * @param date 日期
     * @return end of prev day
     */
    public static Date getEndOfPrevDay(Date date) {
        return new Date(getStartOfDay(date).getTime() - ONE_SECOND);
    }
