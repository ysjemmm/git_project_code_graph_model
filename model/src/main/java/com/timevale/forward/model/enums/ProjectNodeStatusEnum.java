...
public enum ProjectNodeStatusEnum {
    ...
    public static Integer getStatus(List<ProjectNodeDO> projectNodeDOList){
        ...
        return nodeStatusMap.get(ProjectNodeEnum.PUBLISH_OFFICIAL.getText());
    }
    ...
    static {
        ...
        nodeStatusMap.put(ProjectNodeEnum.PUBLISH_OFFICIAL.getText(),        ProjectNodeStatusEnum.PUBLISHED.code);
    }
