...
CREATE TABLE IF NOT EXISTS `product_demand_owner_time` (
  ...
  `create_man_id` varchar(64) DEFAULT NULL COMMENT '创建人ID',
  `create_man` varchar(128) DEFAULT NULL COMMENT '创建人姓名',
  `create_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_man_id` varchar(64) DEFAULT NULL COMMENT '修改人ID',
  `modify_man` varchar(128) DEFAULT NULL COMMENT '修改人姓名',
