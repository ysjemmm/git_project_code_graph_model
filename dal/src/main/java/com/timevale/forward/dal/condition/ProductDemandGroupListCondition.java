...
public class ProductDemandGroupListCondition extends QueryBase {
     ...
     * 产品需求查询条件是否存在
     */
    private Boolean productDemandQueryExist;

    /**
     * 分组创建时间开始
     */
    private Date groupCreateDateStart;

    /**
     * 分组创建时间结束
     */
    private Date groupCreateDateEnd;
    ...
    public Boolean judgeProductDemandQueryExist() {
        return this.id != null ||
                ...
                this.modifyDateEnd != null ||
                CollectionUtils.isNotEmpty(this.filterProductDemandIds) ||
                CollectionUtils.isNotEmpty(this.inProductDemandIds) ||
                CollectionUtils.isNotEmpty(this.notInProductDemandIds) ||
                !Strings.isNullOrEmpty(this.types) ||
                this.expectScheduleTimeStart != null ||
                this.expectScheduleTimeEnd != null;
    }
}
