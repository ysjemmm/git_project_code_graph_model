"""Record Body analyzer for Java AST"""
from typing import List

from loraxmod import ExtractedNode

from parser.languages.java.core.ast_node_types import FieldInfo, MethodInfo, RecordInfo
...
class RecordBodyAnalyzer(BaseAnalyzer):
    """Analyzes Java record body"""
    ...
    def handle_record_body(self, node: ExtractedNode, record_info: RecordInfo, context: AnalyzerContext):
        """Handle record body"""
        ...
        self._record_info.methods = self._extract_methods(context)
        self._record_info.code_blocks = self._extract_code_blocks(context)
